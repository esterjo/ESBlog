...
To understand what follows you need to understand linear algebra and undergraduate probability. **The proof that follows is as clear, honest, and self-contained as I think is possible, but most will not find it easy**. If a truly easy proof (by undergraduate standards) that was theoretically honest were possible you would have already seen it.
