...
This $\vec{\omega}_1$ must be the first eigenvector of the matrix $\text{Cov}(\vec{X})$. Why? **This is the hard part. If you can understand this part you're golden**. There are multiple ways to see why:
